...
ActiveRecord::Schema[7.0].define(version: 2024_04_04_094823) do
  ...
  create_table "settlements", force: :cascade do |t|
    t.decimal "amount"
    t.bigint "expense_split_id", null: false
    t.bigint "user_id", null: false
    t.text "notes"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["expense_split_id"], name: "index_settlements_on_expense_split_id"
  ...
  add_foreign_key "settlements", "expense_splits"
